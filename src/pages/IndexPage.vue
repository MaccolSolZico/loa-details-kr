  ...
  <q-scroll-area style="height: calc(100vh - 32px - 56px)">
    <div class="changelog-page">
      ...
      <div style="font-size: large; margin: 3rem 0 3rem;">
        <div>사용법 : 프로그램 키고 그냥 레이드 돌면 알아서 집계됩니다.</div>
        <br />
        <div>이 미터기는 가라로 뚫어놓은거라 rdps, 시너지% 같은 대부분의 수치들은 제대로 표시되지 않습니다.</div>
        <br />
        <div>또한 로그도 절대 안 만들 것입니다. 왜냐하면 이거 뚫는 것만 해도 귀찮기 때문</div>
        <br />
        <div>참고로 한국은 매주 수요일마다 패치를 하기 떄문에 매주 수요일마다 막힙니다.</div>
        <br />
        <div>새로 뚫리는거 기다리지 마셈 업뎃은해도 기분따라 안뿌리고 나만 쓸 수 있으니</div>
        <br />
        <div>미터기 뿌리는곳 링크 :
          <a
      ...
      <p>
        ...
        <a
          class="custom-link"
          @click="openLinkInBrowser('https://discord.gg/ybujC3sjMy')"
        >
          Discord Server</a
        >
        for full change log.
